...
impl System for MovementSystem {
    fn accesses(&self) -> SystemAccess {
        ...
        access.reads.push(std::any::TypeId::of::<Velocity>().into());
        access
            .writes
            .push(std::any::TypeId::of::<Position>().into());
        access
    }
    ...
    fn run(
        ...
        let span = tracing::info_span!("movement_system", entity_count = world.entity_count());
...
impl System for HealthSystem {
    fn accesses(&self) -> SystemAccess {
        let mut access = SystemAccess::empty();
        access.writes.push(std::any::TypeId::of::<Health>().into());
        access
    }
    ...
    fn run(
        ...
        #[cfg(feature = "profiling")]
        let span = tracing::info_span!("health_system", entity_count = world.entity_count());
...
impl System for QueryAnalysisSystem {
    fn accesses(&self) -> SystemAccess {
        let mut access = SystemAccess::empty();
        access.reads.push(std::any::TypeId::of::<Position>().into());
        access.reads.push(std::any::TypeId::of::<Velocity>().into());
        access
    }
    ...
    fn run(
        ...
        #[cfg(feature = "profiling")]
        let span = tracing::info_span!("query_analysis", query_type = "position_velocity");
        ...
        #[cfg(feature = "profiling")]
        tracing::info!("Analyzed entities successfully");
...
fn setup_profiling_subscriber() {
    #[cfg(feature = "profiling")]
    {
        ...
        let subscriber = Registry::default().with(fmt::layer().with_target(false));
